    ...
    <div>
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-6">
        ...
        >
          ...
          <p className="mt-4 text-white-600 text-center text-base md:text-lg">
          ...
          <a
            ...
            className="mt-6 px-6 py-3 bg-blue-600 te rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300 text-white md:text-base"
          >
            Download My CV!
          </a>
        </section>
        ...
        >
          <div className="max-w-3xl">
            ...
            <p className="text-white-600 mb-4 text-sm md:text-base">
            ...
            {/* Aspirations */}
            <h3 className="text-2xl font-semibold text-white mb-2">Aspirations</h3>
            <p className="text-white-600 mb-4 text-sm md:text-base">
            ...
            {/* Ongoing Learning */}
            <h3 className="text-2xl font-semibold text-white mb-2">Ongoing Learning</h3>
            ...
            <ul className="list-disc list-inside mt-4 text-center text-white-600 text-sm md:text-base">
            ...
            {/* Interests */}
            <h3 className="text-2xl font-semibold text-white mt-6 mb-2">Interests</h3>
            <p className="text-white-600 text-sm md:text-base">
...
>
  <div className="max-w-4xl">
    ...
    <ul className="space-y-6 md:space-y-8">
      <li className="text-xl md:text-2xl font-semibold text-white bg-blue-600 rounded-md p-4 shadow-lg hover:bg-blue-700 transition-all duration-300 cursor-pointer">
        ...
        >
          <div className="max-w-4xl">
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              {/* Frameworks */}
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Frameworks</h2>
                <p className="text-white-700 text-sm md:text-base">
                  PyQT, DB Designer
                </p>
              </div>
        ...
        >
          <div className="max-w-4xl">
            ...
            <div className="mb-8 text-left">
              <h2 className="text-2xl font-bold text-white mb-2">ShedUTrack</h2>
              <p className="text-sm text-white-600 italic mb-1">
            ...
            {/* Project 2 */}
            <div className="mb-8 text-left">
              <h2 className="text-2xl font-bold text-white mb-2">HU-Gym-and-Recreation-Portal</h2>
              <p className="text-sm text-white-600 italic mb-1">
            ...
            {/* Project 3 */}
            <div className="mb-8 text-left">
              <h2 className="text-2xl font-bold text-white mb-2">Pacman Pursuit</h2>
              <p className="text-sm text-white-600 italic mb-1">
            ...
            <div className="text-left">
              <h2 className="text-2xl font-bold text-white mb-2">RISC V Pipelined and Single Cycled Implementation</h2>
              <p className="text-sm text-white-600 italic mb-1">
              ...
              <p className="text-white-700">Skills: Verilog</p>
            </div>
          </div>
        </section>
  ...
  <div className="max-w-4xl">
    ...
    <div className="mb-8 space-y-4">
      <div className="flex flex-col md:flex-row items-center justify-center gap-2">
        ...
        >
          Hammadmalik40a@gmail.com
        </a>
      </div>

      <div className="flex flex-col md:flex-row items-center justify-center gap-2">
        <strong className="text-lg text-white">LinkedIn:</strong> 
        <a 
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-2">
        <strong className="text-lg text-white">Phone:</strong> 
        <a 
...
//             href="/mycv.pdf" // Replace with the actual path to your CV
//             download="Hammad_Malik_CV.pdf" // Set the download file name
//             className="mt-6 px-6 py-3 bg-blue-600 te rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300 text-sm md:text-base"
//           >
//             Download My CV!
//           </a>
//         </section>
...
//             <p className="text-white-700 mb-8 text-sm md:text-base leading-relaxed">
//               I specialize in delivering cutting-edge solutions to help you achieve your goals. Below are the core services I provide:
//             </p>
//             {/* Service List */}
//             <ul className="space-y-6 md:space-y-8">
//               <li className="text-xl md:text-2xl font-semibold text-white bg-blue-100 rounded-md p-4 shadow-md">
//                 Web Application Development
//               </li>
//               <li className="text-xl md:text-2xl font-semibold text-white bg-blue-100 rounded-md p-4 shadow-md">
//                 Mobile Application Development
